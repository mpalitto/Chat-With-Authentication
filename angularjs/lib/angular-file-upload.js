...
angularFileUpload.directive('ngFileSelect', [ '$parse', '$timeout', function($parse, $timeout) {
	...
	return function(scope, elem, attr) {
		...
		// re-entered this since I want the files to be selecteble again even without selction change -Matteo
		// otherwise it would not fire the select function in case same files were selected onto consecutive times
